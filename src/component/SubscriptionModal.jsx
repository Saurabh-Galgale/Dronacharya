...
const SubscriptionModal = ({ open, handleClose }) => {
  return (
    <Modal
      ...
      open={open}
      onClose={handleClose} // The parent now controls the navigation on close
    ...
    >
      <Fade in={open}>
        <Box sx={style}>
          ...
          <Typography id="subscription-success-modal-description" sx={{ mt: 2 }}>
            Your subscription has been activated. You now have full access to all
            our premium content.
          </Typography>
          <Button
            variant="contained"
            onClick={handleClose} // Just trigger the close, which in turn triggers the navigation
