...
const PerformanceAnalysis = () => {
  ...
  if (loading) {
    return (
      <PerformanceAnalysisSkeleton message="⏳ तुमची विश्लेषण माहिती लोड होत आहे..." />
    );
  }

  if (!isSubscribed) {
    return (
      <PerformanceAnalysisSkeleton message="🔒 सविस्तर विश्लेषण पाहण्यासाठी सबस्क्रिप्शन आवश्यक आहे." />
    );
  }
...
// // Enhanced Neon Card with better visibility
// const NeonCard = ({ children, color = "#fff", glowIntensity = "medium" }) => {
//   const glowMap = {
//     low: "20px",
//     medium: "30px",
...
//           boxShadow: `0 8px ${glowMap[glowIntensity]} ${color}25, inset 0 1px 0 rgba(255,255,255,0.1)`,
//           backdropFilter: "blur(10px)",
...
// // Enhanced Stat Pill with better contrast
// const StatPill = ({ label, value, color = "#00E5FF" }) => (
//   <Box
//     sx={{
//       bgcolor: "rgba(15,15,15,0.95)",
...
//   if (!data || !data.categories || !selectedCat) {
//     return (
//       <Box p={3} bgcolor="#000" minHeight="100vh">
